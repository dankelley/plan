...
Evaluating the following code produces text that serves as an example of
the input format expected by `read.burndown()`.
```{r}
library(plan)
data(burndown)
...
Evaluating the following code produces output text that serves as an example
of the input format expected by `read.gantt()`.
```{r}
library(plan)
data(gantt)
print(summary(gantt))
